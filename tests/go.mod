...
require (
	...
	github.com/terraform-ibm-modules/ibmcloud-terratest-wrapper v1.2.14
)
...
require (
	...
	github.com/IBM/platform-services-go-sdk v0.31.0 // indirect
	...
	github.com/gruntwork-io/terratest v0.41.4 // indirect
