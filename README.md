...
[![Terraform Registry](https://img.shields.io/badge/terraform-registry-623CE4?logo=terraform)](https://registry.terraform.io/modules/terraform-ibm-modules/transit-gateway/ibm/latest)
...
<ul>
  ...
  <li><a href="https://github.com/terraform-ibm-modules/terraform-ibm-transit-gateway/tree/main/modules">Submodules</a>
    <ul>
      <li><a href="https://github.com/terraform-ibm-modules/terraform-ibm-transit-gateway/tree/main/modules/terraform-ibm-transit-gateway-action">terraform-ibm-transit-gateway-action</a></li>
    </ul>
  </li>
  <li><a href="https://github.com/terraform-ibm-modules/terraform-ibm-transit-gateway/tree/main/examples">Examples</a>
    <ul>
      <li>
        <a href="https://github.com/terraform-ibm-modules/terraform-ibm-transit-gateway/tree/main/examples/add-prefix-filter">Example transit gateway that connects two VPCs with prefix filtering</a>
      ...
      <li>
        <a href="https://github.com/terraform-ibm-modules/terraform-ibm-transit-gateway/tree/main/examples/basic">Example basic transit gateway</a>
      ...
      <li>
        <a href="https://github.com/terraform-ibm-modules/terraform-ibm-transit-gateway/tree/main/examples/crossaccounts">Example transit gateway that connects two VPCs in two accounts</a>
      ...
      <li>
        <a href="https://github.com/terraform-ibm-modules/terraform-ibm-transit-gateway/tree/main/examples/multiple-connections">Example transit gateway that connects four VPCs through two sets of connections</a>
      ...
      <li>
        <a href="https://github.com/terraform-ibm-modules/terraform-ibm-transit-gateway/tree/main/examples/two-vpcs">Example transit gateway that connects two VPCs</a>
...
| <a name="input_resource_tags"></a> [resource\_tags](#input\_resource\_tags) | Add user resource tags to the Transit Gateway instance to organize, track, and manage costs. [Learn more](https://cloud.ibm.com/docs/account?topic=account-tag&interface=ui#tag-types). | `list(string)` | `[]` | no |
